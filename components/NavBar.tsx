...
const screens = [
  { title: "Adicionar pessoa", icon: <BsPersonFillAdd /> },
  { title: "Celebridades", icon: <BsPersonRaisedHand /> },
  { title: "Fictício", icon: <ImTv /> },
  { title: "Objetos", icon: <BsBox /> },
  { title: "Edifícios", icon: <BsBuilding /> },
  { title: "Animais", icon: <BiSolidDog /> },
  { title: "Pokémon", icon: <MdCatchingPokemon /> },
  { title: "Adicionar imagem", icon: <BsImage />, hideOnMobile: true },
];
